<script lang="ts">
	...
	import SoundCloud from '~icons/mdi/soundcloud';
...
<section class="container">
	...
	<aside class:light={preferences.theme.scheme === 'light'}>
		<nav>
			<a href="https://open.spotify.com/" use:external> <Spotify /> spotify </a>
			<a href="https://soundcloud.com/" use:external> <SoundCloud /> soundcloud </a>
